...
对齐方式：
 None
   ![快捷键.png](/modules/快捷键.png =30%x))
Left: `{.align-left}` 
   ![快捷键.png](/modules/快捷键.png =30%x){.align-left}
Centered: `{.align-center}`
   ![快捷键.png](/modules/快捷键.png =30%x){.align-center}
Right: `{.align-right}`
   ![快捷键.png](/modules/快捷键.png =30%x){.align-right}
Absolute Top Right `{.align-abstopright}`
   ![快捷键.png](/modules/快捷键.png =10%x){.align-abstopright}
